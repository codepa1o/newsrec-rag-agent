...
class Settings:
    ...
    mind_news_path: Path = Path(os.getenv("MIND_NEWS_PATH", "data/mind/MINDsmall_train/news.tsv"))
    mind_behaviors_path: Path = Path(os.getenv("MIND_BEHAVIORS_PATH", "data/mind/MINDsmall_train/behaviors.tsv"))
    ...
    recommend_top_k: int = int(os.getenv("RECOMMEND_TOP_K", "10"))
